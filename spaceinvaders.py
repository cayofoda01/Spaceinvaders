...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        self.path_image_ship = DIRECTORY + "/images/sierra.png"
        background_image = pygame.image.load(DIRECTORY + "/images/backy.jpg")
        explosion_image = pygame.image.load(DIRECTORY + "/images/explosion.png")
        lifes_image = pygame.image.load(DIRECTORY + "/images/corote.jpg")
    ...
    def home_screen(self):
        ...
        mystery = pygame.image.load(DIRECTORY + "/images/ratinho.webp")
    ...
    def create_invaders(self):
        ...
        for i in range(1, 8):
            enemy_types.append(pygame.image.load(DIRECTORY + ("/images/lixo%d.png" % (i % 2))))
